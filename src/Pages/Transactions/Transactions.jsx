...
const Transactions = () => {
    ...
    const url = `https://coinxcrypto-back-end.vercel.app/api/getalldeposit/${id}`
    const url2 = `https://coinxcrypto-back-end.vercel.app/api/getallwithdrawal/${id}`
    const url3 = `https://coinxcrypto-back-end.vercel.app/api/getalltransactions/${id}`
