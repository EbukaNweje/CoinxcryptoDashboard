...
const WithdrawFunds = () => {
    ...
    const url = `https://coinxcrypto.onrender.com/api/requestwithdrawcode/${id}`
    const urlll = `https://coinxcrypto.onrender.com/api/withdraw/${id}`
    const urlprofit = `https://coinxcrypto.onrender.com/api/transferprofittoaccount/${id}`
    const urlemail = `https://coinxcrypto.onrender.com/api/withdrawalemailsend/${id}`
